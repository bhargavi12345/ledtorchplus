...
public class AreaStrategy implements Strategy {
	...
	public double Convert(String from, String to, double input) {
		...
		if ((from.equals(UnitConverter.getInstance()
				...
				.getString(R.string.areaunitsqmiles)) && to
				.equals((UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqkm))))) {
//			 if((from.equals("square miles")) && (to.equals("square km"))){
			double ret = 1.60934 * 1.60934 * input;
			Log.i("testing info details",""+ret);
			return ret;
		}
		if ((from.equals(UnitConverter.getInstance()
				.getApplicationContext().getResources()
				.getString(R.string.areaunitsqkm)) && to
				.equals((UnitConverter.getInstance()
						.getApplicationContext().getResources()
						.getString(R.string.areaunitsqmiles))))) {
//			 if((from.equals("square km")) && (to.equals("square miles"))){
		...
		if ((from.equals(UnitConverter.getInstance()
				...
				.equals(UnitConverter.getInstance()
						.getApplicationContext().getResources()
						.getString(R.string.areaunitsqm)))) {
		...
		if ((from.equals(UnitConverter.getInstance()
				.getApplicationContext().getResources()
				.getString(R.string.areaunitsqm)) && to
				.equals(UnitConverter.getInstance()
						.getApplicationContext().getResources()
						.getString(R.string.areaunitsqmiles)))) {
		...
		if ((from.equals(UnitConverter.getInstance()
				...
				.equals(UnitConverter.getInstance()
						.getApplicationContext().getResources()
						.getString(R.string.areaunitsqcm)))) {
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqcm)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqmiles)))) {
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqmiles)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqmm)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqmiles)))) {
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqyard)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqmiles)))) {
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqkm)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqm)))) {
		...
		if ((from.equals(UnitConverter.getInstance().getApplicationContext()
				.getResources().getString(R.string.areaunitsqm)) && to
				.equals(UnitConverter.getInstance().getApplicationContext()
						.getResources().getString(R.string.areaunitsqkm)))) {
